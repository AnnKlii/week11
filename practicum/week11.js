...
//Подсказка: Используйте метод для изменения текстового содержимого элемента (innerHTML/innerText/textContent)
const pElement = document.getElementById('practicum');
function makeOne() {
	//Ваш код
...
function makeFour() {
	//Ваш код
	const divElement = document.querySelector('#practicum4');
...
function makeTen() {
	//Ваш код
	const object = document.getElementById('practicum10');
...
function makeSixteen() {
	...
	divElement.classList.add('practicum16');
}
...
function makeTwenty() {
	...
	pElement.innerHTML = "Добавлено в начало";
...
function makeTwentyOne() {
	...
	const pElement = document.createElement('p');
	pElement.innerHTML = "Добавлено в конец";
...
function makeTwentyTwo() {
	...
	const testAttribute = image.hasAttribute('src');
	// console.log(testAttribute);
	const result = document.getElementById('result22');
	result.innerHTML = `Атрибут "src" присутствует: ${testAttribute}`;
}
...
function makeTwentyFive() {
	...
	const divElement = document.getElementById('practicum25');
	divElement.setAttribute('data-info', 'Дополнительная информация');
	const newAttribute = divElement.getAttribute('data-info');
	const infoOutput = document.getElementById('infoOutput');
	infoOutput.innerHTML = 'Добавленный атрибут: ' + newAttribute;
}
...
function makeTwentySeven() {
	...
	const divElement = document.getElementById('practicum27');
	const classTest = divElement.classList.contains('highlight');
	// console.log(classTest);
	const result = document.getElementById('result');
	result.textContent = classTest;
}
...
inputTwentyNine.addEventListener('change',
...
divThirty.addEventListener('mouseover',
